...
<a class="nav-link dropdown-toggle text-white" 
   href="<?php echo e(route('shop', [$category->slug])); ?>" 
...
<li>
    <a class="dropdown-item" 
       href="<?php echo e(route('shop', [$category->slug, $subCategory->slug])); ?>">
...
<a href="<?php echo e(route('front.cart')); ?>" class="ml-3 d-flex pt-2">
...
<li>
    <a href="<?php echo e(route('front.page', $page->slug)); ?>" class="text-white text-decoration-none">
...
<ul class="list-unstyled">
<li><a href="<?php echo e(route('login')); ?>" class="text-white text-decoration-none">Login</a></li>
<li><a href="<?php echo e(route('register')); ?>" class="text-white text-decoration-none">Register</a></li>
<li><a href="<?php echo e(route('profile')); ?>" class="text-white text-decoration-none">Orders</a></li>
</ul>
...
© <?php echo e(date('Y')); ?> Amazing Shop
</div>
...
</html><?php /**PATH C:\Users\Admin\Desktop\code\laravel_online_shop\resources\views/front/layouts/app.blade.php ENDPATH**/ ?>