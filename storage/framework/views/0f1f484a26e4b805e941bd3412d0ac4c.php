                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="1" <?php echo e(old('status', $category->status) == 1 ? 'selected' : ''); ?>>
                                    Active
                                </option>

                                <option value="0" <?php echo e(old('status', $category->status) == 0 ? 'selected' : ''); ?>>
                                    Block
                                </option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="showHome" id="showHome" class="form-control">
                                ...
                                <option value="1" <?php echo e(old('showHome', $category->showHome) == 1 ? 'selected' : ''); ?>>
                                    Yes
                                </option>

                                <option value="0" <?php echo e(old('showHome', $category->showHome) == 0 ? 'selected' : ''); ?>>
                                    No
                                </option>
